...
// -----------Type-DROPDOWN---------
const dropdownNav = document.querySelector(".nav-item--type")
...
navType.addEventListener("click", function(e) {
   ...
   dropdownListNav.getElementsByClassName.height = `${dropdownListNav.scrollHeight}px`;
   console.log(dropdownListNav.scrollHeight);
});
...
document.addEventListener("click", function (e) {
    ...
    dropdownListNav.classList.remove("active");
