...
<html lang="en">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="https://hhhkungfu.tv/wp-content/uploads/2021/12/1-copy.png"
      type="image/x-icon"
    />
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Poppins:wght@500;600;700&family=Rubik+Wet+Paint&display=swap"
      rel="stylesheet"
    />
    <!-- OWL CAROUSEL -->
    <link
    ...
    <div class="app">
      ...
      <div class="nav-wrapper">
        <div class="container">
          <div class="nav">
            <a href="#" class="logo">
              <img
                src="https://topfood.id/wp-content/uploads/2020/05/logo-topfood.png"
                alt=""
              />
            </a>
            <ul class="nav-menu" id="nav-menu">
              ...
              <li class="nav-item--type">
                ...
                <ul class="type-list">
                  <li class="type-item">
                    <a
                      href="./movieGenre/actionMovie.html"
                      class="type-item--link"
                      >Phim Hành Động</a
                    >
                  </li>
                  <li class="type-item">
                    <a
                      href="./movieGenre/humorousMovie.html"
                      class="type-item--link"
                      >Phim Hài Hước</a
                    >
                  </li>
                  <li class="type-item">
                    <a
                      href="./movieGenre/FictionMovie.html"
                      class="type-item--link"
                      >Phim Viễn Tưởng</a
                    >
                  </li>
                  <li class="type-item">
                    <a
                      href="./movieGenre/detectiveMovie.html"
                      class="type-item--link"
                      >Phim Trinh Thám</a
                    >
                  </li>
                  <li class="type-item">
                    <a
                      href="./movieGenre/adventureMovie.html"
                      class="type-item--link"
                      >Phim Phiêu Lưu</a
                    >
                  </li>
              ...
              <li class="nav-menu--active custom-btn-sigup">
                <a
                  href="sign_up.php"
                  class="custom-btn btn-11 hover-active btn-sigup"
                >
                  <span>Đăng Ký</span>
                </a>
              </li>
              ...
              <div class="hero-slide-item-content">
                <div class="item-content-wraper">
                  ...
                  <div class="item-action top-down delay-6">
                    <a
                      href="./detail/eveng.html"
                      class="custom-btn block btn-11"
                    >
        ...
        <div class="container">
          <div class="section-header">
            <p class="booton-text">
              <img
                ...
                src="https://web-static.scdn.vn/sendo-buyers-flash-sale-widget/79709a0a/w3front/static/images/6d0b98fffda3d7d5.svg"
                alt=""
              />
            </p>
          </div>
          <div class="movies-slide carousel-nav-center owl-carousel">
            ...
            <a href="./detail/liet_duong.html" class="flash-item">
              <img
                class="flash-image"
                src="https://d1sag4ddilekf6.azureedge.net/compressed_webp/items/VNITE20220511044059036413/detail/b0f99c95_a7b583df339.webp"
                alt=""
              />
              <div class="flash-item-content">
            ...
            <a href="./detail/tamgiac.html" class="flash-item">
              <img
                class="flash-image"
                src="https://gofood.vn/upload/r/ba-chi-1.jpg"
                alt=""
              />
              <div class="flash-item-content">
            ...
            <a href="#" class="flash-item">
              <img
                class="flash-image"
                src="https://gofood.vn/upload/r/san-pham/Ca-hoi-Nauy/fillet/ca-hoi-nauy-fillet-0.jpg"
                alt=""
              />
              <div class="flash-item-content">
            ...
            <a href="#" class="flash-item">
              <img
                class="flash-image"
                src="https://gofood.vn/upload/r/san-pham/gia-vi-Y-tay-ban-nha/gan-ngong/gan-ngong-thai-mieng-0.jpg"
                alt=""
              />
              <div class="flash-item-content">
      ...
      <div class="section">
        <div class="container">
          <div class="banner">
            <img
              src="https://gofood.vn/upload/r/slider/slide-gofood/banner-chuyen-muc/banner-hai-san.jpg"
              alt=""
            />
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="movies-slide carousel-nav-center owl-carousel">
            ...
            <a href="#" class="flash-item">
              <img
                class="flash-image"
                src="https://gofood.vn/upload/r/san-pham/Hai-san-nhat-ban/trung-ca-hoi-nhat-20g-0.jpg"
                alt=""
              />
              <div class="flash-item-content">
                <p class="flash-item-title">Bò xào chua</p>
            ...
            <a href="./detail/tinh_hai_kysi.html" class="flash-item">
              <img
                src="https://gofood.vn/upload/r/san-pham/Hai-san-nhat-ban/thanh-cua-0a.jpg"
                alt=""
              />
              <div class="flash-item-content">
                <p class="flash-item-title">Tinh Hài kỵ Sĩ</p>
            ...
            <a href="#" class="flash-item">
              <img
                class="flash-image"
                src="https://gofood.vn/upload/r/san-pham/Hai-san-nhat-ban/ca-cam-0.jpg"
                alt=""
              />
              <div class="flash-item-content">
                <p class="flash-item-title">Star Trek</p>
            ...
            <a href="./detail/tamgiac.html" class="flash-item">
              <img
                class="flash-image"
                src="https://gofood.vn/upload/r/san-pham/Hai-san-nhat-ban/so-do-0.jpg"
                alt=""
              />
              <div class="flash-item-content">
                <p class="flash-item-title">Thịt ba chỉ bò Mỹ</p>
      ...
      <div class="section">
        <div class="container">
          <div class="contact">
            ...
            <img
              class="contact-img--left"
              src="images/banner/contact2.png"
              alt=""
            />
            <img
              class="contact-img--right"
              src="images/banner/contact1.png"
              alt=""
            />
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-4 col-md-6 col-sm-4">
              <div class="footer-content">
                <a href="#" class="logo">
                  <i class="bx bx-movie-play bx-tada main-color"></i>Mov<span
                    class="main-color"
                    >i</span
                  >e - Plat<span class="main-color">F</span>orm
                </a>
                <p></p>
