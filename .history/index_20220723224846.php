    ...
    <div class="section" id="series">
      <div class="container">
        ...
        <div class="movies-slide carousel-nav-center owl-carousel">
          ...
          $sql = " select * from products where manufacturer_id=N'1' limit 4";
          ...
          <?php foreach ($result as $flashSale) : ?>
            <!-- <div class="tung_san_pham">
              <h1>
                <a href="product.php?id=<?php echo $each['id'] ?>"><?php echo $each['name'] ?></a>
              </h1>
              <img src="admin/san_pham/photos/<?php echo $each['photo'] ?>" height='100' alt="">
