                        ...
                        <div class="row product-info">
                            ...
                            <div class="col-8 col-sm-12">
                                <div class="moive-info">
                                    ...
                                    <div class="rating">
                                        <h5 class="rating-heading">Cơm rang đùi gà</h5>
                        ...
                        <div class="see-more">
                            ...
                            <div class="list-item">
                                ...
                                <a href="#" class="play-movie--link">
                                    <img src="../images/product/sale1.webp" alt="" class="play-movie--img">
                                    <div class="recoment-product">
                                        <p class="play-movie--name">Đùi gà siêu ngon</p>
                                ...
                                <!-- START-ITEM  -->
                                <a href="#" class="play-movie--link">
                                    <img src="../images/product/2.jpg" alt="" class="play-movie--img">
                                    <div class="recoment-product">
                                        <p class="play-movie--name">Đùi gà siêu ngon</p>
                                        <ul class="rating-list recoment">
                                            <li class="rating-item"><i class="rating-item--icon fa-solid fa-star"></i></li>
                                ...
                                <!-- START-ITEM  -->
                                <a href="#" class="play-movie--link">
                                    <img src="../images/product/Haisan/bach-tuoc-0.jpg" alt="" class="play-movie--img">
                                    <div class="recoment-product">
                                        <p class="play-movie--name">Bạch tuộc tươi</p>
                                        <ul class="rating-list recoment">
                                            <li class="rating-item"><i class="rating-item--icon fa-solid fa-star"></i></li>
                                            <li class="rating-item"><i class="rating-item--icon fa-solid fa-star"></i></li>
                                            <li class="rating-item"><i class="rating-item--icon fa-solid fa-star"></i></li>
                                ...
                                <!-- START-ITEM  -->
                                <a href="#" class="play-movie--link">
                                    <img src="../images/product/sashime/sashimi2.jpg" alt="" class="play-movie--img">
                                    <div class="recoment-product">
                                        <p class="play-movie--name">Sashimi cá hồi</p>
                                        <ul class="rating-list recoment">
                                            <li class="rating-item"><i class="rating-item--icon fa-solid fa-star"></i></li>
                                            <li class="rating-item"><i class="rating-item--icon fa-solid fa-star"></i></li>
                                            <li class="rating-item"><i class="rating-item--icon fa-solid fa-star"></i></li>
                                ...
                                <!-- START-ITEM  -->
                                <a href="#" class="play-movie--link">
                                    <img src="../images/product/Haisan/haisan2.jpg" alt="" class="play-movie--img">
                                    <div class="recoment-product">
                                        <p class="play-movie--name">Đùi gà siêu ngon</p>
                                        <ul class="rating-list recoment">
                                            <li class="rating-item"><i class="rating-item--icon fa-solid fa-star"></i></li>
